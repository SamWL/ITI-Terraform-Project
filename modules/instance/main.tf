...
locals {
  ...
  private_instances = {
    "web1" = {
      ...
      instance_name  = "web1"
      file_source    = "/home/Samuel17/ITI-Terraform-Project/web1/index.html"
    }
    "web2" = {
      subnet_id      = var.priv_sub2_id
      instance_name  = "web2"
      file_source    = "/home/Samuel17/ITI-Terraform-Project/web2/index.html"
    }
  }
}
...
resource "aws_instance" "nginx" {
  ...
  connection {
    type        = "ssh"
    user        = "ec2-user"
    private_key = file("/home/Samuel17/Samuel.pem")
    host        = self.public_ip
  }
...
resource "aws_instance" "web" {
  ...
  provisioner "file" {
    ...
    connection {
      ...
      bastion_private_key = file("/home/Samuel17/Samuel.pem")
    }
  }
